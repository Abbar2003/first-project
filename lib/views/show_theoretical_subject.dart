...
class ShowTheoreticalSubject extends StatelessWidget {
  ShowTheoreticalSubject({super.key});
    ...
    return Expanded(
      child: Padding(
        ...
        child: SingleChildScrollView(
          child: FutureBuilder(
            future: theoreticalController.getTheoretical(),
                          ...
                          onTap: () {
                            showDialog(
                                ...
                                builder: (context) => MyDialog(
                                    controller: theoreticalController,
                                    mem: 'doctors',
                                    subjectId:
                                        theoreticalController.decodedRes['data']
                                            [index]['subject_id']));
                          },
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  '${theoreticalController.decodedRes['data'][index]['name_subject']}',
